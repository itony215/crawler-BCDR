...
for num in range(1,1100):
    ...
    test_dict = {'id':num,'breast_laterality': breast_laterality,'asymmetry_type': asymmetry_type,'BIARDS_category': BIARDS_category,'shape': shape,'image_url': image,'source':'BCDR'}
    #print(test_dict)
